            ...
            <div className="row">
              <div className="col-md-12">
                <div className="aligncenter">
                  <h2 className="aligncenter">Courses</h2>Lorem ipsum dolor sit
                  amet, consectetur adipisicing elit. Dolores quae porro
                  consequatur aliquam, incidunt eius magni provident, doloribus
                  omnis minus ovident, doloribus omnis minus temporibus
                ...
                <div className="skill-home-solid clearfix">
                  <div className="col-md-3 text-center">
                    ...
                    <div className="box-area">
                      ...
                      <p>
                        Lorem ipsum dolor sitamet, consec tetur adipisicing
                        elit. Dolores quae porro consequatur aliquam, incidunt
                        eius magni provident
                      </p>
                    </div>
                  </div>
                  <div className="col-md-3 text-center">
              ...
              <div className="col-md-12">
                <div className="section-title text-center">
                  ...
                  <p>
                    ...
                    sollicitudin molestie malesuada Pellentesque <br />
                    ipsum id orci porta dapibus. Vivamus suscipit tortor eget
            ...
            <div className="row">
              <div className="col-md-6 col-sm-6">
                <div className="about-text">
                  <p>
                    Grids is a responsive Multipurpose Template. Lorem ipsum
                  ...
                  <ul className="withArrow">
                    <li>
                      <span className="fa fa-angle-right"></span> Lorem ipsum
                      dolor sit amet
                    </li>
                    <li>
                      <span className="fa fa-angle-right"></span> consectetur
                      adipiscing elit
                    </li>
                    <li>
                      <span className="fa fa-angle-right"></span> Curabitur
                      aliquet quam id dui
                    </li>
                    <li>
                      <span className="fa fa-angle-right"></span> Donec
            ...
            <div className="row">
              <div className="col-md-4">
                ...
                <p>
                  ...
                  voluptatem quia voluptas sit aspernatur. <br />
                  <br />
                  Sed ut perspiciaatis iste natus error sit voluptatem probably
                  ...
                  <div className="panel">
                    <div className="panel-heading">
                      <h4 className="panel-title">
                        ...
                        >
                          <i className="fa fa-angle-right"></i> Accordion
                          Heading Text Item # 1
                        </a>
                      </h4>
                    </div>
              ...
              <div className="col-md-4">
                <div className="timetable">
                  <h3>
                    <span className="fa fa-clock-o"></span> Time Table
                  </h3>
                  <hr />
                  <dl>
                    <dt>Monday - Friday:</dt>
