...
cp ../envs/.env.vidchain-government-frontend implementations/vidchain-government/vidchain-government-frontend/.env
cp ../envs/.env.vidchain-government-backend implementations/vidchain-government/vidchain-government-backend/.env
cp ../envs/.env.vidchain-university-frontend implementations/vidchain-university/vidchain-university-frontend/.env
cp ../envs/.env.vidchain-university-backend implementations/vidchain-university/vidchain-university-backend/.env
